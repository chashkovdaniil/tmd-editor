...
// src/components/TmdEditor.tsx
var React = __toESM(require_react());
var TmdEditor = ({ tmd: initialTmd, refTmd, file, app }) => {
  const [tmd, setTmd] = React.useState(initialTmd);
  const [dirty, setDirty] = React.useState(false);
  const [showDialog, setShowDialog] = React.useState(false);
  const [newExerciseName, setNewExerciseName] = React.useState("");
  const [addAfterIdx, setAddAfterIdx] = React.useState(null);
  ...
  const handleFileNameEmoji = (emoji) => {
  ...
  const handleAddRow = (exerciseIdx) => {
    setTmd((prev) => {
      setDirty(true);
  ...
  const handleShowAddExercise = (afterIdx) => {
  ...
  const handleAddExercise = () => {
    ...
    setTmd((prev) => {
      ...
      const newExercise = { name: newExerciseName.trim(), table };
  ...
  const handleCellChange = (exerciseIdx, rowIdx, colIdx, value) => {
    setTmd((prev) => {
      setDirty(true);
      const exercises = [...prev.exercises];
  ...
  const handleRemoveRow = (exerciseIdx, rowIdx) => {
    setTmd((prev) => {
      setDirty(true);
      const exercises = [...prev.exercises];
  ...
  const handleEditExercise = (idx, currentName) => {
    setEditIdx(idx);
  ...
  return /* @__PURE__ */ React.createElement("div", null, file && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 24 } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600, fontSize: 20 } }, file.basename), /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "\u270E"
  )), tmd.title && /* @__PURE__ */ React.createElement("h2", null, tmd.title), tmd.exercises.map((ex, idx) => /* @__PURE__ */ React.createElement("div", { key: idx, style: { marginBottom: 32 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("h3", { style: { margin: 0 } }, ex.name), /* @__PURE__ */ React.createElement(
    "button",
    {
      style: { color: "#555", background: "none", border: "none", cursor: "pointer", fontSize: 16 },
    ...
    "\xD7"
  )), ex.note && /* @__PURE__ */ React.createElement("div", { style: { fontStyle: "italic", marginBottom: 8 } }, ex.note), /* @__PURE__ */ React.createElement("table", { style: { borderCollapse: "collapse", width: "100%" } }, /* @__PURE__ */ React.createElement("tbody", null, ex.table.map((row, rIdx) => /* @__PURE__ */ React.createElement("tr", { key: rIdx }, row.map((cell, cIdx) => /* @__PURE__ */ React.createElement("td", { key: cIdx, style: { border: "1px solid #ccc", padding: 4 } }, rIdx === 0 ? /* @__PURE__ */ React.createElement("b", null, cell) : /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      value: cell,
  ...
  ))), rIdx !== 0 && /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement(
    "button",
    {
      style: { marginLeft: 8 },
    ...
    "\xD7"
  )))))), /* @__PURE__ */ React.createElement("button", { style: { marginTop: 8 }, onClick: () => handleAddRow(idx) }, "+ \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043F\u043E\u0434\u0445\u043E\u0434"), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => handleShowAddExercise(idx) }, "+ \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0443\u043F\u0440\u0430\u0436\u043D\u0435\u043D\u0438\u0435")))), showDialog && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", background: "rgba(0,0,0,0.3)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1e3 } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", padding: 24, borderRadius: 8, minWidth: 300 } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } }, "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0443\u043F\u0440\u0430\u0436\u043D\u0435\u043D\u0438\u044F:"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setShowDialog(false) }, "\u041E\u0442\u043C\u0435\u043D\u0430"), /* @__PURE__ */ React.createElement("button", { onClick: handleAddExercise, disabled: !newExerciseName.trim() }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C")))), showDeleteDialog && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", background: "rgba(0,0,0,0.3)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1e3 } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", padding: 24, borderRadius: 8, minWidth: 300 } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 16 } }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0443\u043F\u0440\u0430\u0436\u043D\u0435\u043D\u0438\u0435?"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: cancelDeleteExercise }, "\u041D\u0435\u0442"), /* @__PURE__ */ React.createElement("button", { style: { color: "red" }, onClick: confirmDeleteExercise }, "\u0414\u0430")))), showEditDialog && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", background: "rgba(0,0,0,0.3)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1e3 } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", padding: 24, borderRadius: 8, minWidth: 300 } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } }, "\u041D\u043E\u0432\u043E\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0443\u043F\u0440\u0430\u0436\u043D\u0435\u043D\u0438\u044F:"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      value: editName,
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: cancelEditExercise }, "\u041E\u0442\u043C\u0435\u043D\u0430"), /* @__PURE__ */ React.createElement("button", { onClick: confirmEditExercise, disabled: !editName.trim() }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C")))), showFileNameDialog && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", background: "rgba(0,0,0,0.3)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1e3 } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", padding: 24, borderRadius: 8, minWidth: 320 } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } }, "\u041D\u043E\u0432\u043E\u0435 \u0438\u043C\u044F \u0444\u0430\u0439\u043B\u0430:"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      value: fileNameInput,
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: handleFileNameDate }, getCurrentDateStr()), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => handleFileNameEmoji("\u{1F392}") }, "\u{1F392}"), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => handleFileNameEmoji("\u{1F9B5}\u{1F3FC}") }, "\u{1F9B5}\u{1F3FC}"), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => handleFileNameEmoji("\u27A1\uFE0F") }, "\u27A1\uFE0F")), fileNameError && /* @__PURE__ */ React.createElement("div", { style: { color: "red", marginBottom: 8 } }, fileNameError), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: handleFileNameCancel }, "\u041E\u0442\u043C\u0435\u043D\u0430"), /* @__PURE__ */ React.createElement("button", { onClick: handleFileNameSave, disabled: !fileNameInput.trim() }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C")))));
};
...
// src/TmdView.tsx
var TMD_VIEW_TYPE = "tmd-view";
var TmdView = class extends import_obsidian.FileView {
  constructor(leaf) {
    super(leaf);
    this.tmdFile = null;
    this.isLoaded = false;
  ...
  renderEditor() {
    ...
    if (!this.isLoaded || !this.tmdFile) {
      ReactDOM.render(
        /* @__PURE__ */ React2.createElement("div", { style: { padding: 32, textAlign: "center" } }, "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430..."),
        this.containerEl.children[1]
      );
      return;
    }
    const refTmd = async (newTmd) => {
      this.tmdFile = newTmd;
      if (this.file) {
        const md = serializeTmd(this.tmdFile);
        await this.app.vault.modify(this.file, md);
        new import_obsidian.Notice("\u0424\u0430\u0439\u043B \u0430\u0432\u0442\u043E\u0441\u043E\u0445\u0440\u0430\u043D\u0451\u043D");
        console.log("[TMD] TmdView: \u0424\u0430\u0439\u043B \u0430\u0432\u0442\u043E\u0441\u043E\u0445\u0440\u0430\u043D\u0451\u043D", this.file.path);
      }
    };
    ReactDOM.render(
      /* @__PURE__ */ React2.createElement(TmdEditor, { tmd: this.tmdFile, refTmd, file: this.file, app: this.app }),
      this.containerEl.children[1]
    );
...
// src/main.ts
var TmdPlugin = class extends import_obsidian2.Plugin {
  async onload() {
    ...
    this.registerEvent(
      this.app.workspace.on(
        ...
        async (menu, file, source) => {
          menu.addItem((item) => {
            item.setTitle("\u0421\u043E\u0437\u0434\u0430\u0442\u044C tmd-\u0444\u0430\u0439\u043B").setIcon("plus-square").onClick(async () => {
              const folder = file instanceof import_obsidian2.TFolder ? file : file.parent;
              if (!folder) {
          ...
          if (file instanceof import_obsidian2.TFile && file.extension === "md") {
            menu.addItem((item) => {
              item.setTitle("\u0414\u0443\u0431\u043B\u0438\u0440\u043E\u0432\u0430\u0442\u044C (tmd)").setIcon("copy").onClick(async () => {
